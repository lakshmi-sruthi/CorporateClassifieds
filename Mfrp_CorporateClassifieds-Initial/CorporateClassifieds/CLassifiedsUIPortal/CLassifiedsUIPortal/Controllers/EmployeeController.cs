...
namespace CLassifiedsUIPortal.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        public EmployeeController(IEmployeeProvider provider)
        {
        ...
        public async Task<IActionResult> ViewEmployeeOffers()
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    var response2 = await _provider.GetPointsByEmployeeId(employee.EmployeeId, token);
        ...
        public async Task<IActionResult> ViewEmployeeProfile()
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    var response = await _provider.GetPointsByEmployeeId(employee.EmployeeId, token);
